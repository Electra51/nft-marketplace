    ...
    return (
        <div className='w-[270px] h-[373px] bg-white border border-[#F2F2F2] rounded-[13px]'>
            <div className='w-[247px] h-[222px] rounded-[13px] m-[10px] relative'>
                <img src={item.img} alt='' className='h-full w-full object-fill rounded-[13px]' />
            ...
            <div className='mt-[21px] mx-[23px]'>
                ...
                <div className='my-[11px] flex justify-between items-center'>
                    <p className='text-[#5539A8] w-[97px] h-[28px] flex justify-center items-center bg-[#F5F5F5] rounded-[100px] text-[10px]'>{item.time}</p>
                    <p className='text-[15px] font-medium text-[#4F33A3]'>Place a bid</p>
                </div>
            </div>
